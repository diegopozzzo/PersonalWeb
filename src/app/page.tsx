...
.contact-links{display:flex;gap:.9rem;justify-content:center;flex-wrap:wrap;margin-top:1.1rem}
...
<section id="contact" style="position:relative;overflow:hidden;"><div class="contact-glow"></div><div class="contact-inner"><p class="eyebrow reveal" style="justify-content:center">Let's build</p><h2 class="contact-title reveal">Ready to connect<br><span style="background:linear-gradient(135deg,var(--lavender),var(--teal));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">deep systems?</span></h2><p class="contact-body reveal">I'm open to collaboration on deep-tech systems, applied AI, and industrial intelligence — whether you're a startup, a research team, or a company trying to make sense of complex technology.<br><br>Let's talk architecture.</p><a href="mailto:diegopozo@beyondhuman.services" class="contact-email reveal">diegopozo@beyondhuman.services</a><div class="contact-links reveal"><a class="contact-pill wa" href="https://wa.me/51955256450" target="_blank" rel="noreferrer">WhatsApp <strong>+51 955 256 450</strong></a><a class="contact-pill li" href="https://www.linkedin.com/in/diego-pozo-abregu/" target="_blank" rel="noreferrer">LinkedIn <strong>/diego-pozo-abregu</strong></a></div><div class="hero-btns reveal" style="justify-content:center;margin-top:1.2rem"><a href="mailto:diegopozo@beyondhuman.services" class="btn-grad">Send a message</a><a href="https://wa.me/51955256450" class="btn-ghost" target="_blank" rel="noreferrer">WhatsApp</a></div></div></section>
