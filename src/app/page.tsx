...
<nav id="nav"><a href="#" class="nav-logo">DBP<span>A</span></a><ul class="nav-links"><li><a href="#architecture">Architecture</a></li><li><a href="/brochure">Brochure</a></li><li><a href="#nonhuman">NONHUMAN</a></li><li><a href="#gia">GIA PUCP</a></li><li><a href="#magnus">Magnus</a></li><li><a href="#news">News</a></li><li><a href="#preseed">Pre-seed</a></li><li><a href="#projects">Projects</a></li></ul><div class="nav-right"><div class="lang-switch" aria-label="Language switcher"><button class="lang-btn active" data-lang="en" type="button">EN</button><button class="lang-btn" data-lang="es" type="button">ES</button></div><a href="#contact" class="nav-cta">Contact</a></div></nav>
...
<div class="glow-divider"></div><footer><div class="footer-left">© 2026 Diego Bruno Pozo Abregu</div><div class="footer-right"><a href="#architecture">Architecture</a><a href="/brochure">Brochure</a><a href="#nonhuman">NONHUMAN</a><a href="#gia">GIA PUCP</a><a href="#magnus">Magnus</a><a href="#news">News</a><a href="#projects">Projects</a></div></footer>
`;
