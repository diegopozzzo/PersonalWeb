...
body { background: var(--bg); color: var(--white); font-family: var(--font-inter), sans-serif; font-weight: 300; overflow-x: hidden; cursor: auto; }
...
#cursor { position:fixed; width:10px; height:10px; background:var(--lavender); border-radius:50%; pointer-events:none; z-index:9999; transform:translate(-50%,-50%); transition: width .18s, height .18s; mix-blend-mode:screen; }
#cursor-ring { position:fixed; width:28px; height:28px; border:1px solid rgba(255,107,43,0.42); border-radius:999px; pointer-events:none; z-index:9998; transform:translate(-50%,-50%); transition:width .18s, height .18s, border-color .18s, box-shadow .18s; will-change: transform,left,top,width,height; }
nav { position:fixed; top:0; left:0; right:0; z-index:1200; display:flex; justify-content:space-between; align-items:center; padding:1.85rem 3.5rem; background:linear-gradient(to bottom, rgba(10,12,16,0.95), transparent); transition:background .3s, backdrop-filter .3s; }
nav.scrolled { background:rgba(10,12,16,0.92); backdrop-filter:blur(20px); border-bottom:1px solid var(--border); }
.nav-logo { font-family:var(--font-syne), sans-serif; font-size:1.1rem; font-weight:700; letter-spacing:.04em; text-decoration:none; color:var(--white); }
.nav-logo span { color:var(--lavender); }
.nav-links { display:flex; gap:2rem; list-style:none; }
.nav-links a { font-size:.74rem; letter-spacing:.12em; text-transform:uppercase; text-decoration:none; color:var(--dim); transition:color .2s; display:inline-flex; align-items:center; padding:.65rem .55rem; border-radius:12px; }
.nav-links a:focus-visible { outline:2px solid rgba(56,217,180,0.35); outline-offset:2px; }
...
.nav-cta { font-size:.7rem; letter-spacing:.12em; text-transform:uppercase; text-decoration:none; color:var(--bg); background:linear-gradient(135deg, var(--lavender), var(--teal)); padding:.85rem 1.8rem; transition:opacity .2s; display:inline-flex; align-items:center; min-height:44px; border-radius:999px; }
...
.hero-role-company { display:block; font-family:var(--font-syne), sans-serif; font-size:1rem; font-weight:700; letter-spacing:.01em; color:var(--white); margin-bottom:.35rem; }
...
.sec-title { font-family:var(--font-syne), sans-serif; font-size:clamp(2rem,4vw,3.4rem); font-weight:800; letter-spacing:-.03em; line-height:1.05; margin-bottom:1.5rem; }
...
.dash-metrics{display:grid;grid-template-columns:1fr;gap:1rem}
...
.contact-cards{display:grid;grid-template-columns:1fr;gap:.9rem;margin:1.35rem auto 0;max-width:520px}
...
<nav id="nav"><a href="#" class="nav-logo">DBP<span>A</span></a><ul class="nav-links"><li><a href="#architecture">Architecture</a></li><li><a href="/brochure">Brochure</a></li><li><a href="#nonhuman">NONHUMAN</a></li><li><a href="#gia">GIA PUCP</a></li><li><a href="#magnus">Magnus</a></li><li><a href="#news">News</a></li></ul><div class="nav-right"><div class="lang-switch" aria-label="Language switcher"><button class="lang-btn active" data-lang="en" type="button">EN</button><button class="lang-btn" data-lang="es" type="button">ES</button></div><a href="#contact" class="nav-cta">Contact</a></div></nav>
`;
...
<section id="contact" style="position:relative;overflow:hidden;"><div class="contact-glow"></div><div class="contact-inner"><p class="eyebrow reveal" style="justify-content:center">Let's build</p><h2 class="contact-title reveal">Ready to connect<br><span style="background:linear-gradient(135deg,var(--lavender),var(--teal));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">deep systems?</span></h2><p class="contact-body reveal">I'm open to collaboration on deep-tech systems, applied AI, and industrial intelligence — whether you're a startup, a research team, or a company trying to make sense of complex technology.<br><br>Let's talk architecture.</p><div class="contact-cards reveal"><a class="contact-card wa" href="https://wa.me/51955256450" target="_blank" rel="noreferrer"><div class="contact-ic" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M12 3.5C7.31 3.5 3.5 7.09 3.5 11.5c0 1.63.52 3.16 1.41 4.44L4 21l5.26-1.7c1.18.55 2.5.86 3.94.86 4.69 0 8.5-3.59 8.5-8s-3.81-8-8.7-8z" stroke="rgba(56,217,180,.95)" stroke-width="1.5" opacity=".95"/><path d="M9.2 9.1c.18-.42.37-.42.55-.42h.46c.15 0 .35.05.53.28.18.23.7.86.7 2.06 0 1.2-.73 2.36-.84 2.52-.11.16-.16.37.02.7.18.33.8 1.27 1.74 2.06 1.21 1.01 2.23 1.33 2.56 1.47.33.14.52.12.71-.07.19-.18.82-.95 1.04-1.27.22-.33.44-.28.73-.16.29.12 1.84.86 2.15 1.02.31.16.52.23.6.35.07.12.07.7-.17 1.38-.24.67-1.39 1.28-1.95 1.37-.51.08-1.16.12-1.87-.11-.43-.14-.98-.32-1.69-.62-2.97-1.28-4.9-4.41-5.05-4.62-.14-.21-1.2-1.6-1.2-3.05 0-1.45.78-2.17.95-2.38z" fill="rgba(56,217,180,.92)"/></svg></div><div class="contact-txt"><div class="contact-h">WhatsApp</div><div class="contact-s">+51 955 256 450</div></div></a><a class="contact-card li" href="https://www.linkedin.com/in/diego-pozo-abregu/" target="_blank" rel="noreferrer"><div class="contact-ic" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M6.6 9.3H3.9V20h2.7V9.3z" fill="rgba(196,178,255,.95)"/><path d="M5.25 8.1c.92 0 1.66-.73 1.66-1.62S6.17 4.86 5.25 4.86c-.92 0-1.66.73-1.66 1.62S4.33 8.1 5.25 8.1z" fill="rgba(196,178,255,.95)"/><path d="M20.2 20h-2.7v-5.6c0-1.34-.02-3.06-1.93-3.06-1.93 0-2.22 1.45-2.22 2.96V20h-2.7V9.3h2.6v1.46h.04c.37-.68 1.3-1.4 2.67-1.4 2.86 0 3.39 1.82 3.39 4.18V20z" fill="rgba(196,178,255,.95)"/></svg></div><div class="contact-txt"><div class="contact-h">LinkedIn</div><div class="contact-s">linkedin.com</div></div></a><a class="contact-card em" href="mailto:diegopozo@beyondhuman.services"><div class="contact-ic" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M4.5 7.5h15v9.5c0 1.1-.9 2-2 2h-11c-1.1 0-2-.9-2-2V7.5z" stroke="rgba(242,240,237,.85)" stroke-width="1.5"/><path d="M5.2 8.2l6.4 5.1c.3.24.8.24 1.1 0l6.1-5" stroke="rgba(242,240,237,.70)" stroke-width="1.5" opacity=".95"/></svg></div><div class="contact-txt"><div class="contact-h">Email</div><div class="contact-s">diegopozo@beyondhuman.services</div></div></a></div><div class="hero-btns reveal" style="justify-content:center;margin-top:1.25rem"><a href="mailto:diegopozo@beyondhuman.services" class="btn-grad">Send a message</a><a href="https://wa.me/51955256450" class="btn-ghost" target="_blank" rel="noreferrer">WhatsApp</a></div></div></section>
<div class="glow-divider"></div><footer><div class="footer-left">© 2026 Diego Bruno Pozo Abregu</div><div class="footer-right"><a href="#architecture">Architecture</a><a href="/brochure">Brochure</a><a href="#nonhuman">NONHUMAN</a><a href="#gia">GIA PUCP</a><a href="#magnus">Magnus</a><a href="#news">News</a><a href="#contact">Contact</a></div></footer>
`;
